        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.data && data.data.token && data.data.user) {
                    // 使用 SessionUserManager 进行登录
                    const loginSuccess = sessionUserManager.login(data.data.user, data.data.token);
                    
                    if (loginSuccess) {
                        console.log(`标签页 ${sessionUserManager.getTabId()} 登录成功，用户:`, data.data.user.name);
